...
public class CasoBase : MonoBehaviour
{
    public int Caso;
    ...
    public void AbrirCasoClinico() //acessa o Caso Clínico a partir do Hospital
    {
        ...
        CasoClinicoObject.SetActive(true);
        if (GameObject.Find("Hospital").transform.Find("BotoesEscolhas").transform.Find("ManagerEscolhas").GetComponent<Escolhas>().isPIn)
        {
            GameObject.Find("Hospital").transform.Find("BotoesEscolhas").transform.Find("ManagerEscolhas").GetComponent<Escolhas>().prancheta();
        }
    }
